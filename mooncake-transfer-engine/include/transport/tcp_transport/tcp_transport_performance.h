...
#ifndef TCP_TRANSPORT_PERFORMANCE_H_
#define TCP_TRANSPORT_PERFORMANCE_H_
...
class TcpTransportPerformance : public Transport {
   public:
    TcpTransportPerformance();
    ...
    const char *getName() const override { return "tcp_performance"; }
    ...
    Status submitTransferTask(const std::vector<TransferTask *> &task_list);
...
#endif  // TCP_TRANSPORT_PERFORMANCE_H_
